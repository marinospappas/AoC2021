...
class TestDay7 {
    ...
    @Order(1)
    fun `Test Get Input`() {
        val expected = File("src/test/resources/day07/input.txt").readText()
        val input = getInput(arrayOf("src/test/resources/day07/input.txt"))
    ...
    fun `Test Calculate Costs for Each Position Part 1`() {
        positions = getInput(arrayOf("src/test/resources/day07/input.txt"))
        part1_2 = 1
