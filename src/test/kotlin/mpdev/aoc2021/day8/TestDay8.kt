...
class TestDay8 {
    ...
    fun `Test Get Segment Flag`() {
        ...
        val f1 = seg7.getSegmentFlag('A')
        val f2 = seg7.getSegmentFlag('B')
        val f3 = seg7.getSegmentFlag('C')
        val f4 = seg7.getSegmentFlag('D')
        val f5 = seg7.getSegmentFlag('E')
        val f6 = seg7.getSegmentFlag('F')
        val f7 = seg7.getSegmentFlag('G')
    ...
    fun `Test Segments Map`() {
        val inputLine = getInput(arrayOf("src/test/resources/day8/input1.txt")).readLines().first()
    ...
    fun `Test Calculate Result Part 2`() {
        result = calculateResultPart2(arrayOf("src/test/resources/day8/input.txt"))
