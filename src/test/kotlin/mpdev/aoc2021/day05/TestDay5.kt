...
class TestDay5 {
    ...
    fun `Test Process Input Part 1`() {
        val expected = File("src/test/resources/day05/expected1.txt").readText()
        val input = getInput(arrayOf("src/test/resources/day05/input.txt"))
        canvas = Canvas()
    ...
    fun `Test Process Input Part 2`() {
        val expected = File("src/test/resources/day05/expected2.txt").readText()
        val input = getInput(arrayOf("src/test/resources/day05/input.txt"))
        canvas = Canvas()
