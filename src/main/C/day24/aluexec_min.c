...
char * calculateInp_1_8_min();
char * calculateInp_9_14_min();

char * no_solution = "00000000000000";
int z = 0;

void main() {
    char *s1 = calculateInp_1_8_min();
    if (s1 == (char *)0) {
        printf("%s\n", no_solution);
        exit (1);
    }
    char *s2 = calculateInp_9_14_min();
    if (s2 == (char *)0) {
        printf("%s\n", no_solution);
        exit (1);
    }
...
char * calculateInp_1_8_min() {
    for (unsigned char i1 = 1; i1 <= 9; ++i1)
        for (unsigned char i2 = 1; i2 <= 9; ++i2)
            for (int k3_4 = 2; k3_4 >= 0; --k3_4) {
                unsigned char i3_4 = i3_4_arr[k3_4];
                for (unsigned char i5 = 1; i5 <= 9; ++i5)
                    for (int k6_7 = 7; k6_7 >= 0; --k6_7) {
                        unsigned char i6_7 = i6_7_arr[k6_7];
                        for (unsigned char i8 = 1; i8 <= 9; ++i8) {
...
char *calculateInp_9_14_min() {
    for (int k9_10 = 3; k9_10 >= 0; --k9_10) {
    unsigned char i9_10 = i9_10_arr[k9_10];
        for (unsigned char i11 = 1; i11 <= 9; ++i11)
            for (int k12_13 = 4; k12_13 >= 0; --k12_13) {
                unsigned char i12_13 = i12_13_arr[k12_13];
                for (unsigned char i14 = 1; i14 <= 9; ++i14) {
